    ...
    return (
        <div className='maincard w-52'>
            <div className={`card shadow-xl scale-up-top hover:flip-vertical-fwd w-52 border border-secondary-800 rounded-xl  ${color ? 'bg-gradient-to-r from-[#FF5d5d] to-[#DD2476] text-white' : ''}`}>
                <div className='card-front flex flex-col py-4 gap-4 items-center justify-center'>
                ...
                <div className={`card-back items-center justify-center ${color ? 'bg-white text-black' : 'bg-gradient-to-r from-[#DD2476] to-[#FF5d5d] text-white'} absolute top-0 w-full h-full rounded-xl flex flex-col gap-4  text-center`}>
